		...
		?>
			<div class="desc">
				...
				<?php } ?>
					...
					<br><br><a class="btn btn-danger" href="config/deletar_post.php?id=<?php echo $exibe['mensagem_id']?>&fotos_id=<?php echo $mostrar['fotos_id']?>">Deletar</a>&nbsp;<a class="btn btn-primary" href="photos/post.php?id=<?php echo $exibe['mensagem_id']?>&fotos_id=<?php echo $mostrar['fotos_id']?>">Postar no facebook?</a>
			</div>
		<?php } 
